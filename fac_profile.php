...
<body class="bd">
    <div style="display: inline-flex">
        ...
        <div style="color:rgb(163, 39, 163)">
             ...
             <h1> MY PROFILE</h1>
            <form action="save_facd.php" method="post">
            <?php
            ...
            <table>
					...
					<tr><td>Joining Date</td><td>:</td><td><input class="inp" type="date" value="<?php echo $row['joiningdate'] ;?>" name="jdate"></td></tr>
			...
			<?php
					...
					?>
                    <input type="submit" value="Edit" class="sbm" name="editf">
            </form>
